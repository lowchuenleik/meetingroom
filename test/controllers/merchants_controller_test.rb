...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post merchants_url, params: { merchant: { access_code: @merchant.access_code, provider: @merchant.provider, publishable_key: @merchant.publishable_key, uid: @merchant.uid } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { access_code: @merchant.access_code, provider: @merchant.provider, publishable_key: @merchant.publishable_key, uid: @merchant.uid } }
